                        ...
                        <div class="col-sm-6 d-flex">
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item mr-0"><a href="#"
                                        class="text-muted hover-dark">{{ $post->category->title ?? 'No tag' }}</a>
                                </li>
                            </ul>
                        </div>
                                ...
                                <ul class="list-inline mb-0">
                                    ...
                                    @foreach ($categories as $category)
                                        <li class="list-inline-item mb-2" style="cursor: default">
                                            <span
                                                class="px-2 py-1 d-block fs-13 lh-17 bg-gray-03 text-muted hover-white bg-hover-primary rounded">{{ $category->title }}</span>
                                        </li>
                                    @endforeach
