...
<html lang="en">
  <head>
    ...
    <!-- Favicons -->
    <link rel="shortcut icon" type="image/png" href="{{ asset('assets/images/fbi/fbilogo-removebg-preview.png') }}">
    ...
    <meta property="og:image" content="{{ asset("assets/images/fbi/fbilogo-removebg-preview.png") }}">
    ...
    <title>FBILTD Signin/Signup</title>
    <style>
