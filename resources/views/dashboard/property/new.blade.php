                    ...
                    <div class="card-body py-4 py-md-0 px-0">
                      <div class="row">
                          ...
                          <div class="card mb-6">
                            <div class="card-body p-6">
                              ...
                              <div class="form-row mx-n2">
                                ...
                                <div class="col-md-6 col-lg-12 col-xxl-6 px-2 mb-4 mb-md-0">
                                  <div class="form-group mb-0">
                                    <label for="list-in" class="text-heading">Listed
                                      in</label>
                                    <select class="form-control border-0 shadow-none form-control-lg selectpicker"
                                                                title="Select" data-style="btn-lg py-2 h-52"
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card-body p-6">
                              ...
                              <div class="form-row mx-n2">
                                <div class="col-md-6 col-lg-12 col-xxl-6 px-2">
                                  <div class="form-group">
                                    <label for="price" class="text-heading">Price in $ <span
                                ...
                                <div class="col-md-6 col-lg-12 col-xxl-6 px-2">
                                  <div class="form-group">
                                    <label for="tax"
                                                               class="text-heading">Yearly Tax Rate</label>
                              ...
                              <div class="form-row mx-n2">
                                <div class="col-md-6 col-lg-12 col-xxl-6 px-2">
                                  <div class="form-group">
                                    <label for="fee" class="text-heading">Homeowners
                                      Association Fee <span
                                                                    class="text-muted">(monthly)</span></label>
                                    <input type="text"
                                                               class="form-control form-control-lg border-0"
                                                               id="fee" name="fee">
                                  </div>
                                ...
                                <div class="col-md-6 col-lg-12 col-xxl-6 px-2">
                                  <div class="form-group">
                                    <label for="after-price"
                                                               class="text-heading">After Price Label <span
                              ...
                              <div class="form-row mx-n2">
                                <div class="col-md-6 col-lg-12 col-xxl-6 px-2">
                                  <div class="form-group mb-0">
                                    <label for="before-price" class="text-heading">Before
                                      Price label <span
                                                                    class="text-muted">(ex: "from")</span></label>
                                    <input type="text"
                                                               class="form-control form-control-lg border-0"
                          ...
                          <div class="card mb-6">
                            <div class="card-body p-6">
                              <h3 class="card-title mb-0 text-heading fs-22 lh-15">Select Poperty
                                Status</h3>
                              <p class="card-text mb-5">Lorem ipsum dolor sit amet, consectetur
                                adipiscing elit</p>
                              <div class="form-group mb-0">
                                <label for="status"
                                                       class="text-heading">Property Status</label>
                                <select class="form-control border-0 shadow-none form-control-lg selectpicker"
                                                        title="Select" data-style="btn-lg py-2 h-52"
                                ...
                                <div class="col-md-6 col-lg-12 col-xxl-6 px-2">
                                  <div class="form-group mb-md-0">
                                    <label for="embed-video-id"
                                                               class="text-heading">Embed Video id</label>
                          ...
                          <div class="card mb-6">
                            <div class="card-body p-6">
                              ...
                              <div class="form-row mx-n2">
                                <div class="col-md-6 col-lg-12 col-xxl-6 px-2">
                                  <div class="form-group">
                                    <label for="neighborhood" class="text-heading">Neighborhood</label>
                                    <input type="text"
                                                               class="form-control form-control-lg border-0"
                ...
                <div class="card bg-transparent border-0">
                  ...
                  <div id="detail-collapse" class="collapse collapsible"
                    ...
                    <div class="card-body py-4 py-md-0 px-0">
                      <div class="card mb-6">
                        <div class="card-body p-6">
                          ...
                          <div class="row">
                            <div class="col-lg-4">
                              <div class="form-group">
                                <label for="size-in-ft" class="text-heading">Size in ft <span
                                                        class="text-muted">(only numbers)</span></label>
                                <input type="text"
                                                       class="form-control form-control-lg border-0"
                            ...
                            <div class="col-lg-4">
                              <div class="form-group">
                                <label for="lot-size-in-ft"
                                                       class="text-heading">Lot size in ft <span
                                                        class="text-muted">(only numbers)</span></label>
                                <input type="text"
                                                       class="form-control form-control-lg border-0"
                            ...
                            <div class="col-lg-4">
                              <div class="form-group">
                                <label for="room"
                                                       class="text-heading">Rooms</label>
                                <input type="text"
                                                       class="form-control form-control-lg border-0"
                                                       id="room" name="rooms">
                              </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-4">
                              <div class="form-group">
                                <label for="bathrooms"
                                                       class="text-heading">Bathrooms</label>
                                <input type="text"
                                                       class="form-control form-control-lg border-0"
                            ...
                            <div class="col-lg-4">
                              <div class="form-group">
                                <label for="customID"
                                                       class="text-heading">Custom ID <span class="text-muted">(text)</span></label>
                                <input type="text"
                                                       class="form-control form-control-lg border-0"
                            ...
                            <div class="col-lg-4">
                              <div class="form-group">
                                <label for="garage-size"
                                                       class="text-heading">Garage size</label>
                                <input type="text"
                                                       class="form-control form-control-lg border-0"
                            ...
                            <div class="col-lg-4">
                              <div class="form-group">
                                <label for="year-built"
                                                       class="text-heading">Year built <span class="text-muted">(numeric)</span></label>
                                <input type="text"
                                                       class="form-control form-control-lg border-0"
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-4">
                              <div class="form-group">
                                <label for="basement"
                                                       class="text-heading">Basement</label>
                                <input type="text"
                                                       class="form-control form-control-lg border-0"
                            ...
                            <div class="col-lg-4">
                              <div class="form-group">
                                <label for="extra-details"
                                                       class="text-heading">Extra details</label>
                                <input type="text"
                                                       class="form-control form-control-lg border-0"
                            ...
                            <div class="col-lg-4">
                              <div class="form-group">
                                <label for="exterior-material"
                                                       class="text-heading">Exterior Material</label>
                                <input type="text"
                                                       class="form-control form-control-lg border-0"
                            ...
                            <div class="col-lg-4">
                              <div class="form-group">
                                <label for="structure-type"
                                                       class="text-heading">Structure type</label>
                                <select class="form-control border-0 shadow-none form-control-lg selectpicker"
                                                        title="Select" data-style="btn-lg py-2 h-52"
                          ...
                          <div class="row">
                            <div class="col-lg-8">
                              <div class="form-group">
                                <label for="floors-no"
                                                       class="text-heading">Floors no</label>
                                <select class="form-control border-0 shadow-none form-control-lg selectpicker"
                                                        title="Select" data-style="btn-lg py-2 h-52"
                          ...
                          <div class="row">
                            <div class="col-lg-8">
                              <div class="form-group mb-0">
                                <label for="owner"
                                                       class="text-heading">Owner/ Agent nots (not visible on
                                  front end)</label>
                                <textarea class="form-control border-0" id="owner"
                                                          name="owner"></textarea>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="card mb-6">
                        <div class="card-body p-6">
                          <h3 class="card-title mb-0 text-heading fs-22 lh-15">Select Energy
                            Class</h3>
                          <p class="card-text mb-5">Lorem ipsum dolor sit amet, consectetur
                            adipiscing elit</p>
                          <div class="row">
                            <div class="col-lg-6">
                              <div class="form-group mb-lg-0">
                                <label for="energy-class"
                                                       class="text-heading">Energy Class</label>
                                <select class="form-control border-0 shadow-none form-control-lg selectpicker"
                                                        title="Select" data-style="btn-lg py-2 h-52"
                            ...
                            <div class="col-lg-6">
                              <div class="form-group mb-lg-0">
                                <label for="energy-index"
                                                       class="text-heading">Energy index in kWh/m2a</label>
                                <select class="form-control border-0 shadow-none form-control-lg selectpicker"
                                                        title="Select" data-style="btn-lg py-2 h-52"
