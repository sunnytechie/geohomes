    ...
    <section class="pt-9 pb-10">
      <div class="container">
        <div class="d-flex justify-content-center mt-3">
            <a href="/">
                <img width="150" height="50" src="{{ asset('assets/images/fbi/fbilogo.jpg') }}" alt="">
            </a>
        </div>

        <div class="text-center mb-15">
          <img height="350" width="350" src="{{ asset('assets/images/page-404.jpg') }}" alt="Page 404" class="mb-5">
          {{-- <h1 class="fs-22 lh-16 text-dark font-weight-600 mb-5">We are unable to process your request ath the moment. Please try again.</h1> --}}
          <p class="mb-8">You've been blocked from using our services please contact the admin... <br> Here: <a href="{{ route('page.contact') }}">Contact us</a>.</p>
          {{-- <form>
