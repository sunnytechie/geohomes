      ...
      <div class="row mb-6">
        <div class="col-lg-6">
          ...
          {{-- Other details --}}
            <div class="card mb-6">
              <div class="card-body px-6 pt-6 pb-5">
                <h3 class="card-title mb-0 text-heading fs-22 lh-15">Your Brand</h3>
        ...
        <div class="col-lg-6">
            ...
            <div class="card mb-6">
                <div class="card-body px-6 pt-6 pb-5">
                  <h3 class="card-title mb-0 text-heading fs-22 lh-15">Agent category</h3>
            ...
            <div class="card mb-6">
              ...
              <div class="d-flex justify-content-start flex-wrap">
                  <button class="btn btn-lg mb-3 w-100 w-md-auto" style="background: #654321; color: #fff">Join Agents</button>
              </div>
